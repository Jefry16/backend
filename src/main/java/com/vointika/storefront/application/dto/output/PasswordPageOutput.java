...
/**
 * Everything the gate shows: the operator's name and the operator's own message for
 * visitors. Both are public by construction — this is the one storefront address
 * a locked store answers with content.
 */
public record PasswordPageOutput(String operatorName, String passwordMessage) {}
