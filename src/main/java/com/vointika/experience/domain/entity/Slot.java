...
public class Slot {
     ...
     * on one transition only defends that transition: an earlier status-change
     * path carried this check while the capacity-only PATCH did not, and so
     * edited cancelled slots freely.
     */
