        ...
        mockMvc.perform(post("/api/tour-operators/{id}/experiences", OP)
                ...
                .andDo(document("experiences/create",
                        ...
                        requestFields(
                                ...
                                fieldWithPath("tags").description("Filter tags (≤20)").optional(),
                                fieldWithPath("included").description("What's included (≤30)").optional(),
                                fieldWithPath("notIncluded").description("What's not included (≤30)").optional(),
                                fieldWithPath("highlights").description("Highlights (≤20)").optional(),
        ...
        mockMvc.perform(get("/api/tour-operators/{id}/experiences", OP)
                ...
                .andDo(document("experiences/list",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("data[].slug").description("Canonical slug (unique per operator, immutable)"),
                                ...
                                fieldWithPath("data[].tags").description("Filter tags"),
