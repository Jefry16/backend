        ...
        mockMvc.perform(get("/api/tour-operators/{id}/slots", OP)
                ...
                .andDo(document("slots/list",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("data[].status").description("AVAILABLE, SOLD_OUT or CANCELLED. None is an operator toggle — SOLD_OUT is derived from bookings, CANCELLED has its own endpoint"),
        ...
        mockMvc.perform(get("/api/tour-operators/{id}/slots/{slotId}", OP, SLOT)
                ...
                .andDo(document("slots/get",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("status").description("AVAILABLE, SOLD_OUT or CANCELLED. None is an operator toggle — SOLD_OUT is derived from bookings, CANCELLED has its own endpoint"),
